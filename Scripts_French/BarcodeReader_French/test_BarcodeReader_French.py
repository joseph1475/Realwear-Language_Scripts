...
def test_BarcodeReader_French():
    ...
    time.sleep(2)
    voice_commands("Barcode Reader","Lecteur De Code Barres")
    time.sleep(2)

#def test_BarcodeReaderZoomLevels():
...
#def test_BarcodeReaderFlashlight():
    voice_commands("Flashlight On","Allumer lampe de poche")
    time.sleep(2)
    voice_commands("Flashlight Off","Éteindre lampe de poche")
    time.sleep(2)

#def test_BarcodeReaderGobalCommands():
