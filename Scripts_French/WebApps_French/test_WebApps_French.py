...
def test_WebApps_French():
    ...
    time.sleep(2)
    voice_commands("Web Apps","Applications Web")
    time.sleep(2)
    #youtube verifications
    voice_commands("Youtube","Youtube")
    time.sleep(2)
    voice_commands("Refresh Page","Rafraîchir la page")
    time.sleep(4)
    voice_commands("More Options","Plus D'Options")
    time.sleep(2)
    voice_commands("Mouse","Souris")
    time.sleep(2)
    voice_commands("Scan code","Scanner code bar")
    time.sleep(2)
    voice_commands("Navigate Back","Retour En Arrière")
    time.sleep(4)
    voice_commands("Add to Bookmarks","Ajouter aux signets")
    time.sleep(2)
    voice_commands("Cancel","ANNULER")
    time.sleep(2)
    voice_commands("Add to Bookmarks","Ajouter aux signets")
    time.sleep(2)
    voice_commands("Save Bookmark","ENREGISTRER")
    time.sleep(2)
    ...
    voice_commands("Hide Options","Masquer Les Options")
    time.sleep(4)
    voice_commands("Select item 3","Sélectionnez l'élément 3")
    time.sleep(4)
    voice_commands("More Options","Plus D'Options")
    time.sleep(2)
    voice_commands("Scan code","Scanner code bar")
