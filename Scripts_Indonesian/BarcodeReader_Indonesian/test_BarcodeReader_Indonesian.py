...
TC_Name = "Barcode Reader_Indonesian"
cwd = os.getcwd()
...
def test_BarcodeReader_Indonesian():
    device_wakeup()
    ...
    time.sleep(2)
    voice_commands("Barcode Reader","Pembaca Kode Batang")
    time.sleep(2)
...
#def test_BarcodeReaderFlashlight():
    voice_commands("Flashlight On","nyalakan flash")
    time.sleep(2)
    voice_commands("Flashlight Off","matikan flash")
    time.sleep(2)
