...
def test_ClouldSync_French():
    ...
    time.sleep(2)
    voice_commands("Cloud Sync","Synchronisation Cloud")
    time.sleep(3)
    voice_commands("Select Item 1","Sélectionnez l'élément 1")
    time.sleep(3)
    voice_commands("ADVANCED SIGN In","CONNEXION AVANCÉE")
    time.sleep(5)
    voice_commands("Navigate Back","Retour En Arrière")
    time.sleep(4)
    voice_commands("Sign In","SE CONNECTER")
    time.sleep(4)
    #Gobal commands on sign in page
