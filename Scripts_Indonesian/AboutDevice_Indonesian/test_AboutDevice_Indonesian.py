...
TC_Name = "About_Device_Indonesian"
cwd = os.getcwd()
...
def test_AboutDevice_Indonesian():
    device_wakeup()
    ...
    time.sleep(2)
    voice_commands("About Device","Tentang Perangkat")
    time.sleep(2)
    voice_commands("View end user license","LIHAT LISENSI PENGGUNA")
    time.sleep(2)
    voice_commands("Page Down","Halaman Ke Bawah")
    time.sleep(2)
    voice_commands("Page Right","Halaman Ke Kanan")
    time.sleep(2)
    voice_commands("Page Down","Halaman Ke Bawah")
    time.sleep(2)
    voice_commands("Page Left","Halaman Ke Kiri")
    time.sleep(2)
    ...
    voice_commands("About Device","Tentang Perangkat")
    time.sleep(2)
    voice_commands("View open source license","LIHAT LISENSI OPEN SOURCE")
    time.sleep(3)
    voice_commands("Page Down","Halaman Ke Bawah")
    time.sleep(3)
    voice_commands("Page Right","Halaman Ke Kanan")
