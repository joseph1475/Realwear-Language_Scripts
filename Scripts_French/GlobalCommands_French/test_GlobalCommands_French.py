...
def test_GlobalCommands_French():
    device_wakeup()
    ...
    voice_commands("My Programs","Mes Programmes")
    time.sleep(2)
    voice_commands("Settings","Mes Paramètres")
    time.sleep(2)
    voice_commands("Show Help", "Afficher l'aide")
    time.sleep(2)
    voice_commands("Hide Help", "Masquer l'aide")
    ...
    voice_commands("My Programs","Mes Programmes")
    time.sleep(2)
    voice_commands("Tetrominos","TETROMINOS")
    time.sleep(10)
    voice_commands("Show Help", "Afficher l'aide")
    time.sleep(2)
    voice_commands("Hide Help", "Masquer l'aide")
    ...
    voice_commands("My Programs","Mes Programmes")
    time.sleep(2)
    #voice_commands("Wireless Update","MISE À JOUR")
