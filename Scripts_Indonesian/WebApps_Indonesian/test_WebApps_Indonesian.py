...
def test_WebApps_Indonesian():
    ...
    time.sleep(2)
    voice_commands("Web Apps","Aplikasi Jaringan")
    time.sleep(2)
    #youtube verifications
    voice_commands("Youtube","Youtube")
    time.sleep(2)
    voice_commands("Refresh Page","Refresh Halaman")
    time.sleep(4)
    voice_commands("More Options","Pilihan Lain")
    time.sleep(2)
    voice_commands("Mouse","Tetikuis")
    time.sleep(2)
    #voice_commands("Scan code","pindai kode")
    #time.sleep(2)
    #voice_commands("Navigate Back","Satu Tingkat Kembali")
    #time.sleep(4)
    voice_commands("Add to Bookmarks","Tambahkan Penanda Buku")
    time.sleep(2)
    voice_commands("Cancel","BATAL")
    time.sleep(2)
    voice_commands("Add to Bookmarks","Tambahkan Penanda Buku")
    time.sleep(2)
    voice_commands("Save Bookmark","SIMPAN PENANDA BUKU")
    time.sleep(2)
    ...
    voice_commands("Hide Options","Sembunyikan Pilihan")
    time.sleep(4)
    #voice_commands("Select item 3","Pilih nomor 3")
    #time.sleep(4)
    voice_commands("More Options","Pilihan Lain")
    time.sleep(2)
    #voice_commands("Scan code","pindai kode")
