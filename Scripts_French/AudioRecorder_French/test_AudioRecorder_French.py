...
def test_AudioRecorder_French():
    ...
    time.sleep(2)
    voice_commands("Audio Recorder","Enregistreur Audio")
    time.sleep(2)
    voice_commands("Record Audio","Enregistrer l'audio")
    time.sleep(2)
    voice_commands("Pause Recording","Pause l'enregistrement")
    time.sleep(2)
    voice_commands("Resume Recording","Reprendre l'enregistrement")
    time.sleep(2)
    voice_commands("Pause Recording","Pause l'enregistrement")
    time.sleep(2)
    voice_commands("Stop Recording","Arrêter l'enregistrement")
    time.sleep(2)
    voice_commands("Preview","APERÇU")
    time.sleep(2)
    ...
    time.sleep(2)
    voice_commands("Audio Channel","Canal Audio")
    time.sleep(2)
    voice_commands("Audio Channel","Canal Audio")
    time.sleep(2)
    voice_commands("Audio Quality","Qualité Audio")
    time.sleep(2)
    voice_commands("Low Quality","Basse Qualité")
    time.sleep(2)
    voice_commands("Audio Quality","Qualité Audio")
    time.sleep(2)
    voice_commands("Medium Quality","Moyenne Qualité")
    time.sleep(2)
    voice_commands("Audio Quality","Qualité Audio")
    time.sleep(2)
    voice_commands("High Quality","Haute Qualité")
    time.sleep(2)
    voice_commands("Recording Time","Temps d'enregistrement")
    time.sleep(2)
    voice_commands("10 Seconds","10 secondes")
    time.sleep(2)
    voice_commands("Recording Time","Temps d'enregistrement")
    time.sleep(2)
    voice_commands("15 Seconds","15 secondes")
    time.sleep(2)
    voice_commands("Recording Time","Temps d'enregistrement")
    time.sleep(2)
    voice_commands("30 Seconds","30 secondes")
    time.sleep(2)
    voice_commands("Recording Time","Temps d'enregistrement")
    time.sleep(2)
    voice_commands("1 Minute","1 minute")
    time.sleep(2)
    voice_commands("Recording Time","Temps d'enregistrement")
    time.sleep(2)
    voice_commands("Manual","Manuel")
    time.sleep(2)
    voice_commands("Show Help","Afficher l'aide")
    time.sleep(2)
    voice_commands("Hide Help","Masquer l'aide")
    time.sleep(2)
    voice_commands("Show Notifications","Afficher Les Notifications")
    time.sleep(2)
    voice_commands("Hide Notifications","Masquer Les Notifications")
    time.sleep(2)
    voice_commands("My Controls","Mes paramètres")
    time.sleep(2)
    voice_commands("Navigate Back","Retour En Arrière")
    time.sleep(2)
