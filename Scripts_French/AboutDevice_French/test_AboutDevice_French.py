...
def test_AboutDevice_French():
    ...
    time.sleep(2)
    voice_commands("About Device","Infos sur l'appareil")
    time.sleep(2)
    voice_commands("View end user license","VOIR LA LICENCE D'UTILISATEUR FINAL")
    time.sleep(2)
    voice_commands("Page Down","Bas de page")
    time.sleep(2)
    voice_commands("Page Right","page droite")
    time.sleep(2)
    voice_commands("Page Down","Bas de page")
    time.sleep(2)
    voice_commands("Page Left","page gauche")
    time.sleep(2)
    ...
    voice_commands("About Device","Infos sur l'appareil")
    time.sleep(2)
    voice_commands("View open source license", "AFFICHER LA LICENCE DE SOURCE OUVERTE")
    time.sleep(2)
    voice_commands("Page Down","Bas de page")
    time.sleep(2)
    voice_commands("Page Right","page droite")
