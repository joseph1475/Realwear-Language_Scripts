...
def test_AboutDevice_Spanish():
    ...
    time.sleep(2)
    voice_commands("About Device","Acerca de dispositivo")
    time.sleep(2)
    voice_commands("View end user license","VER LICENCIA DE USUARIO")
    time.sleep(2)
    voice_commands("Page Down","Bajar página")
    time.sleep(2)
    voice_commands("Page Right","Derecha de página")
    time.sleep(2)
    voice_commands("Page Down","Bajar página")
    time.sleep(2)
    voice_commands("Page Left","Izquierda de página")
    time.sleep(2)
    ...
    voice_commands("About Device","Acerca de dispositivo")
    time.sleep(2)
    voice_commands("View open source license","Ver licencia de código abierto")
    time.sleep(2)
    voice_commands("Page Down", "Bajar página")
    time.sleep(2)
    voice_commands("Page Right", "Derecha de página")
