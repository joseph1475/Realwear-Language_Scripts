...
TC_Name = "AudioRecorder_Indonesian"
cwd = os.getcwd()
...
def test_AudioRecorder_Indonesian():
    device_wakeup()
    ...
    time.sleep(2)
    voice_commands("Audio Recorder","Perekam Audio")
    time.sleep(2)
    voice_commands("Record Audio","Rekaman Audio")
    time.sleep(2)
    voice_commands("Pause Recording","Jeda Rekaman")
    time.sleep(2)
    voice_commands("Resume Recording","Lanjutkan Rekaman")
    time.sleep(2)
    voice_commands("Pause Recording","Jeda Rekaman")
    time.sleep(2)
    ...
    time.sleep(2)
    voice_commands("Audio Channel","Saluran Audio")
    time.sleep(2)
    voice_commands("Audio Channel","Saluran Audio")
    time.sleep(2)
    voice_commands("Audio Quality","Kualitas Audio")
    time.sleep(2)
    voice_commands("Low Quality","kualitas rendah")
    time.sleep(3)
    voice_commands("Audio Quality","Kualitas Audio")
    time.sleep(2)
    voice_commands("Medium Quality","Kualitas Menengah")
    time.sleep(3)
    voice_commands("Audio Quality","Kualitas Audio")
    time.sleep(2)
    voice_commands("High Quality","kualitas tinggi")
    time.sleep(2)
    voice_commands("Recording Time","durasi rekaman")
    time.sleep(5)
    """
    voice_commands("10 Seconds","10 detik")
    time.sleep(2)
    voice_commands("Recording Time","durasi rekaman")
    time.sleep(2)
    voice_commands("15 Seconds","15 detik")
    time.sleep(2)
    voice_commands("Recording Time","durasi rekaman")
    time.sleep(2)
    ...
    voice_commands("Recording Time","durasi rekaman")
    time.sleep(2)
    voice_commands("1 Minute","1 menit")
    time.sleep(2)
    voice_commands("Recording Time","durasi rekaman")
    time.sleep(2)
    voice_commands("Manual","MANUAL")
    time.sleep(2)
    """
    ...
    time.sleep(2)
    voice_commands("Show Notifications","Tampilkan Notifikasi")
    time.sleep(2)
    voice_commands("Hide Notifications","Sembunyikan Pemberitahuan")
    time.sleep(2)
