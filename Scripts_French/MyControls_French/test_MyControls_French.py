...
def test_MyControls_French():
    ...
    voice_commands("Action Button","Bouton d'action")
    time.sleep(1)
    voice_commands("Homescreen","Écran d'accueil")
    time.sleep(2)
    ...
    time.sleep(1)
    voice_commands("Bluetooth settings","Paramètres Bluetooth")
    time.sleep(3)
    voice_commands("Navigate Home","Menu Principal")
    time.sleep(2)
    voice_commands("My Controls","Mes paramètres")
    time.sleep(3)
    voice_commands("Wireless Network","Réseau sans fil")
    time.sleep(1)
    voice_commands("Wireless Network settings","Paramètres du réseau sans fil")
    time.sleep(5)
    ...
    #voice_commands("My Controls","Mes paramètres")
    #time.sleep(2)
    #voice_commands("Preferred Network","préférences wifi")
    #time.sleep(2)
    #voice_commands("Navigate Back","Retour En Arrière")
    #time.sleep(3)
    voice_commands("Navigate Home","Menu Principal")
    ...
    voice_commands("My Controls","Mes paramètres")
    time.sleep(2)
    voice_commands("Brightness","Luminosité")
    time.sleep(1)
    ...
    voice_commands("Color mode","Mode couleur")
    time.sleep(2)
    voice_commands("Dictation","Dictée")
    time.sleep(2)
    voice_commands("Dictation","Dictée")
    time.sleep(2)
    ...
    voice_commands("Layout mode","Mode de Mise en Page")
    time.sleep(2)
    voice_commands("More settings","Autres paramètres")
    time.sleep(2)
    voice_commands("Navigate back","Retour En Arrière")
    time.sleep(2)
