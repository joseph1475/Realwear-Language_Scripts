...
def test_ClouldSync_Indonesian():
    device_wakeup()
    ...
    time.sleep(2)
    voice_commands("Cloud Sync","Sinkronisasi Cloud")
    time.sleep(3)
    voice_commands("Select Item 1","Pilih Nomer 1")
    time.sleep(3)
    voice_commands("ADVANCED SIGN In","CANGGIH MASUK")
    time.sleep(5)
    voice_commands("Navigate Back","Satu Tingkat Kembali")
    time.sleep(4)
    voice_commands("Sign In","MASUK")
    time.sleep(4)
