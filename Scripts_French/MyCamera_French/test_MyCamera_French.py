...
def test_MyCamera_French():
    ...
    time.sleep(2)
    voice_commands("Flash On", "Lampe de poche allumée")
    time.sleep(2)
    voice_commands("Flash Off", "Lampe de poche éteinte")
    time.sleep(2)
    ...
    time.sleep(2)
    voice_commands("Image Resolution", "Résolution de l'image")
    time.sleep(2)
    ...
    time.sleep(2)
    voice_commands("Video Resolution", "Résolution vidéo")
    time.sleep(2)
    voice_commands("Low", "Basse")
    time.sleep(2)
    voice_commands("Video Resolution", "Résolution vidéo")
    ...
    voice_commands("High", "Haute")
    time.sleep(2)
    voice_commands("Frame rate", "Fréquence d'images")
    time.sleep(2)
    ...
    time.sleep(2)
    voice_commands("Record Video", "Enregistrer une vidéo")
    time.sleep(10)
    voice_commands("Stop Recording", "Arrêter l'enregistrement")
    time.sleep(2)
    voice_commands("Preview", "APERÇU")
    time.sleep(2)
    voice_commands("Video Pause", "Pause Vidéo")
    time.sleep(2)
    voice_commands("Video Play", "Lecture Vidéo")
    time.sleep(2)
    voice_commands("Video Rewind", "Rembobiner Vidéo")
    time.sleep(2)
    voice_commands("Video Forward", "Avancer Vidéo")
    time.sleep(2)
    voice_commands("Video Stop", "Arrêter Vidéo")
    time.sleep(2)
