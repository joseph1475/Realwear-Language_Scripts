...
def test_Spanish_AudioRecorder():
    device_wakeup()
    ...
    time.sleep(2)
    voice_commands("Audio Recorder","Grabador de audio")
    time.sleep(2)
    voice_commands("Record Audio","Grabar audio")
    time.sleep(2)
    voice_commands("Pause Recording","PAUSA GRABACIÓN")
    time.sleep(2)
    voice_commands("Resume Recording","REANUDAR GRABACIÓN")
    time.sleep(2)
    voice_commands("Pause Recording","PAUSA GRABACIÓN")
    time.sleep(2)
    ...
    time.sleep(2)
    voice_commands("Audio Channel","CANAL DE AUDIO")
    time.sleep(2)
    voice_commands("Audio Channel","CANAL DE AUDIO")
    time.sleep(2)
    voice_commands("Audio Quality","CALIDAD DE AUDIO")
    time.sleep(2)
    voice_commands("Low Quality","CALIDAD BAJA")
    time.sleep(2)
    voice_commands("Audio Quality","CALIDAD DE AUDIO")
    time.sleep(2)
    voice_commands("Medium Quality","CALIDAD MEDIA")
    time.sleep(2)
    voice_commands("Audio Quality","CALIDAD DE AUDIO")
    time.sleep(2)
    voice_commands("High Quality","CALIDAD ALTA")
    time.sleep(2)
    voice_commands("Recording Time","DURACIÓN DE GRABACIÓN")
    time.sleep(2)
    voice_commands("10 Seconds","10 segundos")
    time.sleep(2)
    voice_commands("Recording Time","DURACIÓN DE GRABACIÓN")
    time.sleep(2)
    voice_commands("15 Seconds","15 segundos")
    time.sleep(2)
    voice_commands("Recording Time","DURACIÓN DE GRABACIÓN")
    time.sleep(2)
    ...
    voice_commands("Recording Time", "DURACIÓN DE GRABACIÓN")
    time.sleep(2)
    voice_commands("1 Minute","1 minuto")
    time.sleep(2)
    voice_commands("Recording Time","DURACIÓN DE GRABACIÓN")
    time.sleep(2)
    ...
    voice_commands("Navigate Back","IR atrás")
    time.sleep(2)
    voice_commands("Hide Options","OCULTAR AYUDA")
    time.sleep(2)
