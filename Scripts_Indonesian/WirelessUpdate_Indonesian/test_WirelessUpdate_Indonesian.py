...
TC_Name = "WirelessUpdate_Indonesian"
cwd = os.getcwd()
...
def test_WirelessUpdate_Indonesian():
    ...
    time.sleep(2)
    voice_commands("Wireless Update","Pembaruan nirkabel")
    time.sleep(4)
    voice_commands("Select Item 2","Pilih Nomer 2")
    time.sleep(2)
    voice_commands("Local Updates","Pembaharuan lokal")
    time.sleep(2)
    ...
    voice_commands("Select Item 2","Pilih Nomer 2")
    time.sleep(2)
    voice_commands("Setting","Pengaturan")
    time.sleep(2)
    voice_commands("Show Help","Minta Bantuan")
    time.sleep(2)
    voice_commands("Hide Help","Sembunyikan Bantuan")
    ...
    time.sleep(2)
    #Checking  update
    voice_commands("Check for updates","Memeriksa untuk pembaruan")
    time.sleep(5)
    voice_commands("My Controls","Pengaturan Pemakai")
    time.sleep(2)
    voice_commands("Navigate Back","Satu Tingkat Kembali")
