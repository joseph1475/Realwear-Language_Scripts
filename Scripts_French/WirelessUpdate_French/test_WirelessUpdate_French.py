...
def test_WirelessUpdate_French():
    ...
    time.sleep(2)
    voice_commands("Select item 8", "Sélectionnez l'élément 8")
    time.sleep(8)
    #voice not detected for wireless update so select item used
    #voice_commands("Wireless Update","")
    #time.sleep(6)
    voice_commands("Select Item 2","Sélectionnez l'élément 2")
    time.sleep(6)
    ...
    time.sleep(2)
    #Checking  update
    voice_commands("Check for updates","Recherche des mises à jour")
    time.sleep(5)
    voice_commands("My Controls","Mes paramètres")
    time.sleep(2)
    voice_commands("Navigate Back","Retour En Arrière")
