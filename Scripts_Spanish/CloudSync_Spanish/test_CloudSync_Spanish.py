...
def test_ClouldSync_Spanish():
    ...
    time.sleep(2)
    voice_commands("Cloud Sync","Sincronización en la nube")
    time.sleep(3)
    voice_commands("Select Item 1","Elemento 1")
    time.sleep(3)
    voice_commands("ADVANCED SIGN In","INICIAR SESIÓN AVANZADA")
    time.sleep(5)
    voice_commands("Navigate Back","Ir atrás")
    time.sleep(4)
    voice_commands("Sign In","INICIAR SESIÓN")
    time.sleep(4)
...
"""
    ...
    time.sleep(2)
    voice_commands("Cloud Sync")
    time.sleep(2)
    voice_commands("Select Item 1")
    time.sleep(2)
    voice_commands("Sign In")
    time.sleep(2)
    voice_commands("Navigate Back")
    time.sleep(2)
"""
