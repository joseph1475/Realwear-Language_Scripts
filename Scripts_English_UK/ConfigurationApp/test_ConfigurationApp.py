...
#def test_ConfigurationAppLaunching():
    ...
    time.sleep(2)
    voice_commands("Configuration")
    time.sleep(2)

#def test_ConfigurationAppZoomLevels():
...
#def test_ConfigurationAppFlashlight():
    voice_commands("Flashlight On")
    time.sleep(2)
    voice_commands("Flashlight Off")
    time.sleep(2)
#def test_ConfigurationAppGobalCommands():
